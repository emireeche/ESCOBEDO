<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('empleado_id',$empleados, $usuario->empleado_id, ['class' => 'form-control' . ($errors->has('empleado_id') ? ' is-invalid' : ''), 'placeholder' => 'Empleado Id']) }}
            {!! $errors->first('empleado_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('tipousuario_id') }}
            {{ Form::select('tipousuario_id', $tipousuario, $usuario->tipousuario_id, ['class' => 'form-control' . ($errors->has('tipousuario_id') ? ' is-invalid' : ''), 'placeholder' => 'Tipousuario Id']) }}
